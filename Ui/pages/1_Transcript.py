"""
📝 Transcript Analyzer — Paste & Analyze

Cyberpunk-themed interface for pasting raw meeting transcripts
and viewing role-aware analysis results from the MeetingAnalyzer engine.
...
# ===================================================================== #
st.set_page_config(
    page_title="📝 Transcript | Private Intelligence",
    page_icon="📝",
    layout="wide",
...
if process:
    if not transcript or not transcript.strip():
        st.warning("⚠️  Paste a transcript first.")
    else:
        ...
        with st.status(
            ...
            status.update(label="🧠  Analyzing transcript with Gemma …")
